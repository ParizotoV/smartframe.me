	...
	return (
		<Layout>
			<Helmet>
				...
				<meta description="SmartFrame" value="SmartFrame" />
			</Helmet>
			<div className='bg-gray-200 md:overflow-hidden'>
				<div className='px-4 py-16'>
					<div className='relative w-full md:max-w-2xl md:mx-auto text-center'>
						...
						>
							A simple and smart tool that will transform your old tablet/phone
            </h1>
						...
						<div className='flex flex-wrap -mx-4'>
								...
								<div className='flex flex-wrap -mx-4 mb-10'>
									<div className='w-1/4 px-4'>
										<div className='text-center mb-10 bg-white shadow rounded-lg p-6'>
											<div
												className='w-10 h-10 rounded-full bg-green-600 mb-4 mx-auto'
											></div>
									...
									<div className='w-1/4 px-4'>
										<div className='text-center mb-10 bg-white shadow rounded-lg p-6'>
											<div
												className='w-10 h-10 rounded-full bg-blue-600 mb-4 mx-auto'
											></div>
											<div className='h-2 rounded-full bg-gray-200'></div>
										</div>
									</div>
									<div className='w-1/4 px-4'>
										<div className='text-center mb-10 bg-white shadow rounded-lg p-6'>
											<div
												className='w-10 h-10 rounded-full bg-orange-400 mb-4 mx-auto'
											></div>
											<div className='h-2 rounded-full bg-gray-200'></div>
										</div>
									</div>
									<div className='w-1/4 px-4'>
										<div className='text-center mb-10 bg-white shadow rounded-lg p-6'>
											<div
												className='w-10 h-10 rounded-full bg-blue-800 mb-4 mx-auto'
											></div>
											<div className='h-2 rounded-full bg-gray-200'></div>
										</div>
									</div>
							...
							<div className='w-1/3 px-4'>
								...
								<div className='flex justify-between my-10'>
									...
									<div>
										<div
											className='ml-auto h-2 w-5 bg-gray-300 rounded-full mb-2'
										></div>
										<div
											className='ml-auto h-2 w-6 bg-gray-300 rounded-full mb-2'
										></div>
					...
					<div className='flex' style={{ height: '340px' }}>
						...
						<div className='flex-1 py-6 px-4'>
							<div className='flex flex-wrap -mx-2'>
								<div className='w-1/3 px-2'>
									<div
										className='text-center mb-6 bg-white shadow rounded-lg px-2 py-3'
									>
										<div
											className='w-4 h-4 rounded-full bg-green-600 mb-2 mx-auto'
										></div>
								...
								<div className='w-1/3 px-2'>
									...
									>
										<div
											className='w-4 h-4 rounded-full bg-blue-600 mb-2 mx-auto'
										></div>
										<div className='h-2 w-8 mx-auto rounded-full bg-gray-200'></div>
									</div>
								</div>
								<div className='w-1/3 px-2'>
									...
									>
										<div
											className='w-4 h-4 rounded-full bg-orange-600 mb-2 mx-auto'
										></div>
										<div className='h-2 w-8 mx-auto rounded-full bg-gray-200'></div>
									</div>
								</div>
							...
							<div className='flex flex-wrap -mx-2 mb-6'>
								...
								<div className='w-1/2 px-2'>
									<div className='rounded-lg shadow px-2 py-2'>
										<div
											className='block w-8 h-2 rounded-full bg-gray-200 mb-2'
										></div>
